(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68869,n=>{"use strict";var m=n.i(86900);function t(){var n;let t;n=n=>{let m=document.documentElement;n.theme&&("dark"===n.theme?m.classList.add("dark"):m.classList.remove("dark")),n.accent&&("monochrome"===n.accent?m.removeAttribute("data-theme"):m.setAttribute("data-theme",n.accent)),n.font&&(m.classList.remove("font-serif","font-sans","font-mono"),"serif"===n.font?m.classList.add("font-serif"):"sans-serif"===n.font?m.classList.add("font-sans"):"monospace"===n.font&&m.classList.add("font-mono"))},t=m.useRef(n),m.useEffect(()=>{t.current=n},[n]),m.useEffect(()=>{if(window.self===window.top)return;let n=n=>{"example-params"===n.data.type&&t.current(n.data.data)};return window.addEventListener("message",n),()=>{window.removeEventListener("message",n)}},["example-params"])}n.s(["useSendThemeToIframes",()=>t],68869)},42836,n=>{"use strict";var m=n.i(88102);n.s(["Button",()=>m.B])},60331,n=>{"use strict";var m=n.i(2582);n.i(82419);var t=n.i(42836),e=n.i(78270),o=n.i(87143),a=n.i(99071),s=n.i(27668),d=n.i(765),r=n.i(22931),i=n.i(73468),c=n.i(53779),l=n.i(86900),C=n.i(68869);let u=`import {
  Button,
  CommandDialog,
  CommandEmpty,
  CommandGroup,
