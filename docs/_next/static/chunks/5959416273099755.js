(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,45173,e=>{"use strict";var i=e.i(75201);function d(){var e;let d;e=e=>{let i=document.documentElement;e.theme&&("dark"===e.theme?i.classList.add("dark"):i.classList.remove("dark")),e.accent&&("monochrome"===e.accent?i.removeAttribute("data-theme"):i.setAttribute("data-theme",e.accent)),e.font&&(i.classList.remove("font-serif","font-sans","font-mono"),"serif"===e.font?i.classList.add("font-serif"):"sans-serif"===e.font?i.classList.add("font-sans"):"monospace"===e.font&&i.classList.add("font-mono"))},d=i.useRef(e),i.useEffect(()=>{d.current=e},[e]),i.useEffect(()=>{if(window.self===window.top)return;let e=e=>{"example-params"===e.data.type&&d.current(e.data.data)};return window.addEventListener("message",e),()=>{window.removeEventListener("message",e)}},["example-params"])}e.s(["useSendThemeToIframes",()=>d],45173)},46402,e=>{"use strict";var i=e.i(45171);e.s(["Input",()=>i.I])},75874,e=>{"use strict";var i=e.i(98134);e.i(26940);var d=e.i(14499),t=e.i(50391),r=e.i(21496),l=e.i(66086),s=e.i(79938),n=e.i(41525),a=e.i(46402),o=e.i(45173);let c=`import {
  Field,
  FieldDescription,
  FieldGroup,
  FieldLabel,
