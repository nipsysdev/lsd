(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68869,e=>{"use strict";var o=e.i(86900);function t(){var e;let t;e=e=>{let o=document.documentElement;e.theme&&("dark"===e.theme?o.classList.add("dark"):o.classList.remove("dark")),e.accent&&("monochrome"===e.accent?o.removeAttribute("data-theme"):o.setAttribute("data-theme",e.accent)),e.font&&(o.classList.remove("font-serif","font-sans","font-mono"),"serif"===e.font?o.classList.add("font-serif"):"sans-serif"===e.font?o.classList.add("font-sans"):"monospace"===e.font&&o.classList.add("font-mono"))},t=o.useRef(e),o.useEffect(()=>{t.current=e},[e]),o.useEffect(()=>{if(window.self===window.top)return;let e=e=>{"example-params"===e.data.type&&t.current(e.data.data)};return window.addEventListener("message",e),()=>{window.removeEventListener("message",e)}},["example-params"])}e.s(["useSendThemeToIframes",()=>t],68869)},14908,e=>{"use strict";var o=e.i(16879);e.s(["Autocomplete",()=>o.b])},12623,e=>{"use strict";var o=e.i(2582);e.i(82419);var t=e.i(14908),a=e.i(46184),l=e.i(68869);let s=[{value:"1",label:"Option 1"},{value:"2",label:"Option 2"},{value:"3",label:"Option 3"}],n=`import { Autocomplete } from '@nipsys/shadcn-lsd';
