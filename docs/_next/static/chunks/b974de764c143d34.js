(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68869,e=>{"use strict";var r=e.i(86900);function t(){var e;let t;e=e=>{let r=document.documentElement;e.theme&&("dark"===e.theme?r.classList.add("dark"):r.classList.remove("dark")),e.accent&&("monochrome"===e.accent?r.removeAttribute("data-theme"):r.setAttribute("data-theme",e.accent)),e.font&&(r.classList.remove("font-serif","font-sans","font-mono"),"serif"===e.font?r.classList.add("font-serif"):"sans-serif"===e.font?r.classList.add("font-sans"):"monospace"===e.font&&r.classList.add("font-mono"))},t=r.useRef(e),r.useEffect(()=>{t.current=e},[e]),r.useEffect(()=>{if(window.self===window.top)return;let e=e=>{"example-params"===e.data.type&&t.current(e.data.data)};return window.addEventListener("message",e),()=>{window.removeEventListener("message",e)}},["example-params"])}e.s(["useSendThemeToIframes",()=>t],68869)},42836,e=>{"use strict";var r=e.i(88102);e.s(["Button",()=>r.B])},86409,e=>{"use strict";var r=e.i(58640);e.s(["Input",()=>r.I])},35482,e=>{"use strict";var r=e.i(471);e.s(["useForm",()=>r.u])},45792,e=>{"use strict";var r=e.i(2582);e.i(82419);var t=e.i(42836),o=e.i(44403),s=e.i(82395),l=e.i(35368),n=e.i(5282),a=e.i(51988),m=e.i(78356),i=e.i(33936),c=e.i(80877),d=e.i(86409),u=e.i(88711),h=e.i(44096),F=e.i(69817),f=e.i(47691),g=e.i(17200),p=e.i(78956),x=e.i(35482),b=e.i(68869);let j=`import { Button, Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage, Input, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Switch, Checkbox, useForm } from '@nipsys/shadcn-lsd';
