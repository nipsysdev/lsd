(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,68869,e=>{"use strict";var r=e.i(86900);function s(){var e;let s;e=e=>{let r=document.documentElement;e.theme&&("dark"===e.theme?r.classList.add("dark"):r.classList.remove("dark")),e.accent&&("monochrome"===e.accent?r.removeAttribute("data-theme"):r.setAttribute("data-theme",e.accent)),e.font&&(r.classList.remove("font-serif","font-sans","font-mono"),"serif"===e.font?r.classList.add("font-serif"):"sans-serif"===e.font?r.classList.add("font-sans"):"monospace"===e.font&&r.classList.add("font-mono"))},s=r.useRef(e),r.useEffect(()=>{s.current=e},[e]),r.useEffect(()=>{if(window.self===window.top)return;let e=e=>{"example-params"===e.data.type&&s.current(e.data.data)};return window.addEventListener("message",e),()=>{window.removeEventListener("message",e)}},["example-params"])}e.s(["useSendThemeToIframes",()=>s],68869)},42836,e=>{"use strict";var r=e.i(88102);e.s(["Button",()=>r.B])},86409,e=>{"use strict";var r=e.i(58640);e.s(["Input",()=>r.I])},35482,e=>{"use strict";var r=e.i(471);e.s(["useForm",()=>r.u])},80753,e=>{"use strict";var r=e.i(2582);e.i(82419);var s=e.i(42836),o=e.i(82395),a=e.i(35368),t=e.i(5282),m=e.i(51988),n=e.i(78356),l=e.i(33936),i=e.i(80877),d=e.i(86409),c=e.i(35482),u=e.i(68869);let F=`import { Button, Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage, Input, useForm } from '@nipsys/shadcn-lsd';
