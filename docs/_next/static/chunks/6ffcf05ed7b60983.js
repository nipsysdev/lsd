(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,45173,a=>{"use strict";var e=a.i(75201);function t(){var a;let t;a=a=>{let e=document.documentElement;a.theme&&("dark"===a.theme?e.classList.add("dark"):e.classList.remove("dark")),a.accent&&("monochrome"===a.accent?e.removeAttribute("data-theme"):e.setAttribute("data-theme",a.accent)),a.font&&(e.classList.remove("font-serif","font-sans","font-mono"),"serif"===a.font?e.classList.add("font-serif"):"sans-serif"===a.font?e.classList.add("font-sans"):"monospace"===a.font&&e.classList.add("font-mono"))},t=e.useRef(a),e.useEffect(()=>{t.current=a},[a]),e.useEffect(()=>{if(window.self===window.top)return;let a=a=>{"example-params"===a.data.type&&t.current(a.data.data)};return window.addEventListener("message",a),()=>{window.removeEventListener("message",a)}},["example-params"])}a.s(["useSendThemeToIframes",()=>t],45173)},61417,a=>{"use strict";var e=a.i(20607);a.s(["Typography",()=>e.T])},16117,a=>{"use strict";var e=a.i(50674);a.s(["Tabs",()=>e.T])},4656,a=>{"use strict";var e=a.i(98134);a.i(26940);var t=a.i(16117),s=a.i(38205),n=a.i(91563),r=a.i(22410),o=a.i(61417),i=a.i(45173);let b=`import { Tabs, TabsContent, TabsList, TabsTrigger, Typography } from '@nipsys/shadcn-lsd';
