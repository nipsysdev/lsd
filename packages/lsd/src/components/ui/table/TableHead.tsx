  ...
  ({ className, ...props }, ref) => {
    return (
      <th
        ...
        className={cn(
          'lsd:h-10 lsd:px-(--lsd-spacing-small) lsd:text-left lsd:align-middle lsd:font-bold lsd:whitespace-nowrap lsd:[&:has([role=checkbox])]:pr-0 lsd:*:[[role=checkbox]]:translate-y-[2px]',
          className
        )}
        {...props}
      />
