...
function RadioGroupItem({ className, ...props }: RadioGroupItemProps) {
  return (
    ...
    >
      ...
      >
        <CircleIcon className="lsd:absolute lsd:top-1/2 lsd:left-1/2 lsd:size-2 lsd:-translate-x-1/2 lsd:-translate-y-1/2 lsd:fill-lsd-primary" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  );
}
