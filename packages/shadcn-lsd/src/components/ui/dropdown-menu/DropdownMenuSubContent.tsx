  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        'lsd:z-50 lsd:min-w-[8rem] lsd:origin-[var(--radix-dropdown-menu-content-transform-origin)]',
        // Overflow and shape
        'lsd:overflow-hidden lsd:rounded-md lsd:border lsd:bg-[var(--lsd-surface)] lsd:p-1',
        // Animation
