  ...
  return (
    <div className="flex flex-col gap-(--lsd-spacing-base) w-80">
      <div className="flex flex-col gap-(--lsd-spacing-smaller)">
        ...
        <Slider value={smValue} onValueChange={setSmValue} max={100} step={1} size="sm" aria-label="Small slider" />
      ...
      <div className="flex flex-col gap-(--lsd-spacing-smaller)">
        ...
        <Slider value={mdValue} onValueChange={setMdValue} max={100} step={1} size="md" aria-label="Medium slider" />
        <Typography variant="label1" className="text-secondary">
      ...
      <div className="flex flex-col gap-(--lsd-spacing-smaller)">
        ...
        <Slider value={lgValue} onValueChange={setLgValue} max={100} step={1} size="lg" aria-label="Large slider" />
        <Typography variant="label1" className="text-secondary">
